...
def converter_data_v1(valor_data, formato_entrada, formato_saida='%Y-%m-%d %H:%M:%S.%f'):
...
for tabela, campo, valor, formato in formatos_de_datas:
    data_convertida_v1 = converter_data_v1(
        valor_data=valor,
    ...
    if data_convertida_v1 != data_convertida:
        print(f"[{tabela}].[{campo}]: '{valor}' -> {data_convertida_v1}")
